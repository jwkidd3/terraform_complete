...
1. In the top bar, near the right, you'll see your username/alias. Click on it which will show a dropdown
...
1. Once your IDE loads, you should see a Welcome document. Feel free to take a moment to read through the welcome document.
...
```bash
curl -O https://releases.hashicorp.com/packer/1.7.2/packer_1.7.2_darwin_amd64.zip 
sudo unzip packer_1.7.2_linux_amd64.zip -d /usr/bin/
```
...
```bash
git clone https://github.com/christianhxc/terraform-advanced-workshop.git workshop
```
